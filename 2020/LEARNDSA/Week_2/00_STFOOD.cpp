...
/*
For every iteraton, increase number of stores by 1, because Chef wants a new store.
Calculate the price of each food per person. The maximum of these types is the answer.
*/
