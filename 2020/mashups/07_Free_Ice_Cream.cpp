...
/*
If there exists ice cream equal to or greater than the requested amount, subtract it
Otherwise increase count of kids in distress
Increase ice cream by given amount if the character is '+'
*/
