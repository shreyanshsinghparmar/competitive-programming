...
If we choose  as our set, we can see that after removing all instances of them, the new array will become  which is of size , hence lesser than half of the original array size.
