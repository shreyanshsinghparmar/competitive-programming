...
/*
In every iteration, choose the minimum encountered so far and distribute it among boxes.
Example:
* 2 1 3
* Iteration 1: Take 2, distribute
* Iteration 2: Take 1, distribute
* Iteration 3: Take 1, distribute
This way, in no box we put any number of tokens beyond it's capacity because we are choosing minimum so far encountered.
*/
