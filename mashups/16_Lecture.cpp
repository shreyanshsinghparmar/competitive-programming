...
/*
Map the words to the word with lowest length out of those
For example,
ab a
* Here a < ab
* So a maps to a and ab maps to a
* This way, we get a for ab and for a
* Which means we get shortest word out of both languages for each word
*/
