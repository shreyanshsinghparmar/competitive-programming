...
/*
 * Greedy approach
It's optimal to choose the dragons with the lowest strengths and collect their bonuses
* If at any instant a dragon cannot be defeated, the game can't be won
*/
